...
|Element: _resource collection_|The referenced resources represented by Ant resource collections. | No; can appear arbitrary number of times, but at least either a _resource collection_ or a _despends_ element must be specified.
